# -*- coding: utf-8 -*-
"""CES-D1_Feature_Selection_using_GA.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1SF_uQwWIOzXrndLIDUglKoerPAO4qr8K
"""
...
file_path = "/content/CES SCORE.xlsx"
...
import numpy as np
population = np.random.randint(0, 2, (100,120))
...
def two_point_crossover(parents, probability):
    # Convert parents to a NumPy array if it's not already
    ...
    for num in range(no_of_pairs):
        # Ensure there are at least 2 parents to choose from
        if len(parents) < 2:
